...
(defmacro ove-set-prefix-arg (map arg)
  `(define-key ,map (kbd ,(number-to-string arg))
     (lambda () (interactive)
       (if (numberp last-command)
           (setq prefix-arg (+ (* last-command 10) ,arg))
         (setq prefix-arg ,arg))
       (setq this-command prefix-arg))))
(ove-set-prefix-arg ove-mode-map 0)
(ove-set-prefix-arg ove-mode-map 1)
(ove-set-prefix-arg ove-mode-map 2)
(ove-set-prefix-arg ove-mode-map 3)
(ove-set-prefix-arg ove-mode-map 4)
(ove-set-prefix-arg ove-mode-map 5)
(ove-set-prefix-arg ove-mode-map 6)
(ove-set-prefix-arg ove-mode-map 7)
(ove-set-prefix-arg ove-mode-map 8)
(ove-set-prefix-arg ove-mode-map 9)

(ove-set-prefix-arg ove-emacs/ckm-map 0)
(ove-set-prefix-arg ove-emacs/ckm-map 1)
(ove-set-prefix-arg ove-emacs/ckm-map 2)
(ove-set-prefix-arg ove-emacs/ckm-map 3)
(ove-set-prefix-arg ove-emacs/ckm-map 4)
(ove-set-prefix-arg ove-emacs/ckm-map 5)
(ove-set-prefix-arg ove-emacs/ckm-map 6)
(ove-set-prefix-arg ove-emacs/ckm-map 7)
(ove-set-prefix-arg ove-emacs/ckm-map 8)
(ove-set-prefix-arg ove-emacs/ckm-map 9)
